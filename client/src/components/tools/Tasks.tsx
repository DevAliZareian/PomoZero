...
export default function Tasks() {
  const { tasks, currentTask, setCurrentTask, setTaskForm, taskForm } = useTasks();
        ...
        tasks.map((task) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={(e) => {
                  e.preventDefault(), setTaskForm({ show: true, editor: { id: task.id, title: task.title, pomodoros: task.pomodoros } });
